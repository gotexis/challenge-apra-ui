...
export default function SearchBar({ onSubmit }: {
    ...
    return <form className="flex items-center my-1" onSubmit={event => {
        ...
        <div className="relative w-full">
            ...
            <input
                ...
                type="text"
                className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full pl-10 p-2.5" placeholder="Search" 
            />
        </div>
